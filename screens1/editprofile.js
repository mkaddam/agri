...
import {View,TouchableWithoutFeedback,Text,Keyboard, TouchableOpacity,ImageBackground,TextInput,StyleSheet,} from 'react-native';
...
export default function EditProfile () {
    ...
    useEffect(() => 
    {
        ...
        {
          axios.post("http://192.168.1.4:80/new/modif.php",JSON.stringify
                ({
                      email:email,
                      country:country,
                      city:city,
  ...
  return(
    <ImageBackground source={ require('../assets/images/theme3.jpg')} style={styles.image}>
